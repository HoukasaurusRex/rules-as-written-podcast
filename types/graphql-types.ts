...
export type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark___frontmatter___contentSnippet'
  ...
  | 'childMarkdownRemark___frontmatter___contentSnippet'
  ...
  | 'childrenEpisodeDataJson___contentSnippet'
  ...
  | 'childEpisodeDataJson___contentSnippet'
...
export type EpisodeDataJsonConnectionMaxArgs = {
  field: EpisodeDataJsonFieldsEnum;
};


export type EpisodeDataJsonConnectionMinArgs = {
  field: EpisodeDataJsonFieldsEnum;
};


export type EpisodeDataJsonConnectionSumArgs = {
  field: EpisodeDataJsonFieldsEnum;
};
...
export type Unnamed_1_Query = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author' | 'keywords' | 'siteUrl' | 'image' | 'lang'>> }> };

export type EpisodePageQueryVariables = Exact<{
  slug: Scalars['String'];
}>;


export type EpisodePageQuery = { markdownRemark?: Maybe<{ frontmatter?: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'pubDate' | 'guid' | 'title' | 'contentSnippet' | 'videoId' | 'slug'>
