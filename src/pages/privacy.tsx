...
const PrivacyPage: () => JSX.Element = () => (
  <>
    ...
    >
      ...
      <Heading as="h1" paddingTop="70px" paddingBottom="3rem" textAlign="center">Rules As Written<br/>Privacy Policy</Heading>

      <Text>At Rules as Written, accessible from https://rulesaswrittenshow.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Rules as Written and how we use it.</Text>
      ...
      <Text>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Rules as Written. This policy is not applicable to any information collected offline or via channels other than this website.</Text>

      <Heading as="h2" py="2rem">Consent</Heading>

      <Text>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</Text>

      <Heading as="h2" py="2rem">Information we collect</Heading>
      ...
      <Heading as="h2" py="2rem">How we use your information</Heading>
      ...
      <Heading as="h2" py="2rem">Log Files</Heading>

      <Text>Rules as Written follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</Text>




      <Heading as="h2" py="2rem">Advertising Partners Privacy Policies</Heading>

      <Text>You may consult this list to find the Privacy Policy for each of the advertising partners of Rules as Written.</Text>

      <Text>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on Rules as Written, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.</Text>

      <Text>Note that Rules as Written has no access to or control over these cookies that are used by third-party advertisers.</Text>

      <Heading as="h2" py="2rem">Third Party Privacy Policies</Heading>

      <Text>Rules as Written's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. </Text>
      ...
      <Heading as="h2" py="2rem">CCPA Privacy Rights (Do Not Sell My Personal Information)</Heading>
      ...
      <Heading as="h2" py="2rem">GDPR Data Protection Rights</Heading>
      ...
      <Heading as="h2" py="2rem">Children's Information</Heading>
