      ...
      <Box position="relative" minH="100vh">
        ...
        <Center flexDir="column">
          ...
          >
            <Popover>
              ...
              <PopoverContent>
                ...
                <PopoverBody>
                  ...
                  <Text>
                    If you know your way around YouTube captioning and would like to be a part of
                    the Rules as Written team to help improve this page, visit{' '}
                    <Link
            ...
            <Button
              as="a"
              href="https://anchor.fm/rules-as-written/support"
              target="_blank"
              m="1rem"
            >
